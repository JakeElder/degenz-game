...
const CATEGORY_IDS: Record<CategorySymbol, string> = {
  ...
  ENTRANCE: "948248656593702932",
  JOIN_THE_GAME: "954236807216791562",
...
const CHANNEL_IDS: Record<ChannelSymbol, string> = {
  ...
  ENTER_THE_PROJECTS: "946437609155088464",
  ENTER_THE_SHELTERS: "954237539139612702",
  ...
  METRO: "-",
  ORIENTATION: "951414355432452146",
...
const ROLE_IDS: Record<RoleSymbol, string> = {
  ...
  HIGH_COMMAND: "940505529871130634",
  ...
  THOUGHT_POLICE: "957957689751785512",

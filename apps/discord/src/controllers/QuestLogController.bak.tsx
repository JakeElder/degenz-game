...
export default class QuestLogController {
  ...
  static async toggleQuest(userId: User["id"], quest: QuestSymbol) {}
  ...
  //       await Promise.all(
  //         this.quests.map((q) => this.updateQuestMessage(user, q.symbol))
  //       );
  //     })
  //   );
  // }

  // static async updateQuestMessage(user: User, questSymbol: QuestSymbol) {
  ...
  //   await this.updateQuestMessage(channel.user, questSymbol);
